...
//     multitimeline.pause(5.5);
//     multitimeline.play(6);


//TweenMax.set("#brush-2", {scale: 0.8, x: -35, y: -45});
...
//      .fromTo("#gradient", 0.3, {autoAlpha: 0, scale: 5}, {autoAlpha: 1, scale: 1, transformOrigin: "0% 100%", repeat: 1, yoyo: true, ease:Power1.easeOut}, 0)
      ...
      .fromTo("[id*='moto']", 2.8, {y: 100, x: 280, rotation: -80}, {y: 50, x: -260, rotation: 30, transformOrigin: "142px 131px", ease:new SlowMo(0.5, 0.8)}, 0.5)
...
function fr4(){
  var tl_ = new TimelineMax({repeat: 0});  
      ...
      .fromTo("[id*='txt-1']", 0.8, {clip:"rect(70px 300px 0px 0px)"}, {clip:"rect(0px 300px 70px 0px)", ease:Power3.easeOut}, 0.6)
