...
//multitimeline.pause(15);
TweenMax.set("#brush-2", {scale: 0.65});
TweenMax.set("#brush-3", {scale: 0.65});
...
function fr1(){
      var tl_ = new TimelineMax({repeat: 0});  
          ...
          .fromTo("[id*='skater']", 2.3, {y: 100, x: -250, rotation: -20}, {y: 0, x: 180, rotation: 50, transformOrigin: "246px 124px", ease:new SlowMo(0.5, 0.8)}, 0)
...
//      .fromTo("#gradient", 0.3, {autoAlpha: 0, scale: 5}, {autoAlpha: 1, scale: 1, transformOrigin: "0% 100%", repeat: 1, yoyo: true, ease:Power1.easeOut}, 0)
      ...
      .fromTo("[id*='bike']", 2.8, {y: 100, x: -350, rotation: -50}, {y: 0, x: 330, rotation: 30, transformOrigin: "34px 55px", ease:new SlowMo(0.5, 0.8)}, 0.5)
...
//      .fromTo("#gradient", 0.3, {autoAlpha: 0, scale: 5}, {autoAlpha: 1, scale: 1, transformOrigin: "0% 100%", repeat: 1, yoyo: true, ease:Power1.easeOut}, 0)
      ...
      .fromTo("[id*='moto']", 2.8, {y: 100, x: 280, rotation: -80}, {y: 50, x: -360, rotation: 30, transformOrigin: "142px 131px", ease:new SlowMo(0.5, 0.8)}, 0.5)
...
function fr4(){
  var tl_ = new TimelineMax({repeat: 0});  
      ...
      .fromTo("[id*='txt-1']", 0.8, {clip:"rect(63px 300px 0px 0px)"}, {clip:"rect(0px 300px 63px 0px)", ease:Power3.easeOut}, 0.6)
