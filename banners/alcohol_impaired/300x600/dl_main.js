...
function fr1(){
  var tl_ = new TimelineMax();  
      tl_.timeScale(0.7);  
      tl_
      .from('#mask', 1, {x: 155, y: 430,  ease: Power1.easeOut }, 0)
      .from('[id*="rip-"]', 1, {x: 155, y: 200, scale: 0, transformOrigin: "50% 100%", ease: Power1.easeOut }, 0)
      .from('#car', 1, {x: 240, y: 430,  ease: Power1.easeOut }, 0)          
