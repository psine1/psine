...
.to("[id*='city-1'], [id*='city-6']", 18, {ease:Power1.easeInOut, x: -923}, 0)
.to("[id*='city-2']", 18, {ease:Power1.easeInOut, x: -918}, 0)

.to("[id*='gradient']", 18, {ease:Power1.easeInOut, x: -923}, 0)
.fromTo("[id*='city-3']", 18, {x: -40}, {ease:Power1.easeInOut, x: -923}, 0)
.fromTo("[id*='city-4'], [id*='city-8']", 18, {x: -50}, {ease:Power1.easeInOut, x: -800}, 0)
.fromTo("[id*='city-5']", 18, {x: -160}, {ease:Power1.easeInOut, rotation: 1.3, y: -3, x: -850}, 0)

.to("[id*='city-6'], [id*='city-7']", 18, {ease:Power1.easeInOut, x: -923}, 0)
.to("[id*='wind-']", 18, {ease:Power1.easeInOut, x: -923}, 0)
