...
tl_
  ...
  //    .to('[id*="cookie"]', 1, {scale: 1.05, repeat: 1, yoyo: true, ease:Power3.easeOut}, 0.5)
      .to('[id*="img-"]', 0.45, {repeat: 0, x: -748, ease: SteppedEase.config(4)}, 0.3)
      .staggerFromTo('[id*="particle-"]', 1.3, {repeat: 0, scale: 0, y: 0, x: -50, ease:Power3.easeOut}, {scale: 5, x: 100, y: -55}, 0, 0.3)
