...
tl_
      ...
      .from('[id*="logo-m"]', 0.5, {autoAlpha: 0, ease:Power3.easeOut}, 0.9)

      .to('[id*="nuevo"]', 0.5, {autoAlpha: 0, ease:Power3.easeOut}, 0)
      .to('[id*="logo-init"]', 0.5, {autoAlpha: 0, ease:Power3.easeOut}, 0)

      .from('[id*="txt-1"]', 0.2, {autoAlpha: 0, y: 10, ease:Power3.easeOut}, 0.2)
      .to('[id*="txt-1"]', 0.2, {autoAlpha: 0, ease:Power3.easeOut}, 1.2)

      .from('[id*="txt-2"]', 0.2, {autoAlpha: 0, y: 10, ease:Power3.easeOut}, 1.5)
      .to('[id*="txt-2"]', 0.2, {autoAlpha: 0, ease:Power3.easeOut}, 2.5)      

      .from('[id*="txt-3"]', 0.2, {autoAlpha: 0, y: 10, ease:Power3.easeOut}, 2.7)
     // .to('[id*="txt-3"]', 0.8, {autoAlpha: 0, ease:Power3.easeOut}, 3)            


   //   .to('[id*="cookie"]', 1, {scale: 1.05, repeat: 1, yoyo: true, ease:Power3.easeOut}, 0.5)
      .to('[id*="img-"]', 0.45, {repeat: 0, x: -1032, ease: SteppedEase.config(4)}, 0.3)
      .staggerFromTo('[id*="particle-"]', 1, {repeat: 0, scale: 0, y: 0, x: 0, ease:Power3.easeOut}, {scale: 4.5, y: 50, x: 180}, 0, 0.3)
      .to('[id*="particle-"]', 1, {autoAlpha: 0, ease:Power3.easeOut})
    //  .to('[id*="cookie"]', 5, {scale: 1, ease:Power3.easeOut}, 0.3)
      .to('[id*="cookie"]', 0.7, {y: -22, ease:Power3.easeOut}, 0.3)
