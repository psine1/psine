...
tl_
    ...
    //  .to('[id*="cookie"]', 1, {scale: 1.05, repeat: 1, yoyo: true, ease:Power3.easeOut}, 0.5)
      .to('[id*="img-"]', 0.45, {repeat: 0, x: -1140, ease: SteppedEase.config(4)}, 0.3)
      .staggerFromTo('[id*="particle-"]', 0.8, {repeat: 0, scale: 0, y: 0, x: 0, ease:Power3.easeOut}, {scale: 4.5, y: -50, x: 100}, 0, 0.3)
      .to('[id*="particle-"]', 1, {autoAlpha: 0, ease:Power3.easeOut})
      .to('[id*="cookie"]', 1, {scale: 0.95, ease:Power3.easeOut}, 0.3)
