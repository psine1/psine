...
.to(".txt-2", 1.2, {y: -12, scale: 0.9, ease:Power2.easeOut}, 5)


.from(".txt-3", 1, {autoAlpha: 0, ease:Power2.easeOut}, 5)

.to(".cookie", 1, {x: -100, autoAlpha: 0 , ease:Power2.easeOut}, 5)

.from(".footer", 1, {x: -130, ease:Power2.easeOut}, 5)
.from(".package", 1, {autoAlpha: 0, ease:Power2.easeOut}, 5.2)
