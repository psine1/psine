...
function fr1(){
    ...
    .to("[id*='animShine']", {duration: 7, x: -300, y: -300, ease: "power3.out"}, 1)
    ;
return tl_  
}
...
function fr2(){
    ...
    .from("[id*='img-1']", {duration: 1, scale: 3.3, transformOrigin: "50% 50%", y: -61, x: 1, ease: "power3.sout"}, 0)
   // .from("[id*='bg']", {duration: 2, scale: 3, ease: "power3.out"}, 0)
    ...
    .to("[id*='smoke-1-a']", {duration: 3, autoAlpha: 0, scale: 1.5, ease: "power3.out"}, 0)
    .to("[id*='smoke-1-b']", {duration: 3, autoAlpha: 0, scale: 1.5, ease: "power2.out"}, 0)
...
function fr3(){
    ...
    tl_.timeScale( 1 );  
    tl_
    .from("[id*='img-screen']", {duration: 8, x: 40, ease: "power3.out"}, 0.3)
    .fromTo("[id*='img-screen']", {scale: 1.15, transformOrigin: "50% 50%"}, {duration: 11, scale: 1, transformOrigin: "50% 50%", ease: "power3.out"}, 0.3)  

    //.fromTo("[id*='svgId-2']", {x: 300}, {duration: 3.5, x: -500, ease: "power2.inOut"}, 0)
    .fromTo("[id*='svgId-2']", {x: 900}, {duration: 2, x: 200, ease: "power2.inOut"}, 0)
    .fromTo("[id*='svg-screen2']", {x: -1070}, {duration: 2, x: 0, ease: "power2.inOut"}, 0.5)


    .to("[id*='wrap-screen']", {duration: 5, scale: 0.65, x: -150, y: -95, ease: "power3.inOut"}, 4.5)

    .fromTo("#maskTv", {x: 500, y: 210, scale: 2.8, transformOrigin: "50% 50%"}, {duration: 5, scale: 1, x: 0, y: 0, ease: "power3.inOut"}, 4.5)
...
function fr4(){
    ...
    .to("[id*='img-ft6']", {duration: 6, scale: 1.3, transformOrigin: "30% 30%", ease: "power3.out"}, 0)
...
function fr5(){
    ...
    .from("[id*='dust']", {duration: 3, autoAlpha: 0, ease: "power3.out"}, 0)
      ...
      .from("#dust img", {duration: 25, ease: "none", x: -1955, repeat: -1},0)
      .from("#dust2 img", {duration: 25, ease: "none", x: -1955, repeat: -1},0)
