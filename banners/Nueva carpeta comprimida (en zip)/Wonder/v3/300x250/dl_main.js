...
.from("#icon-4", 1, {y: 100, x: -100, ease:Power2.easeOut}, 0.5)
...
tl_.timeScale( 1 );  
tl_
.to("#circle-1", 1.2, {y: 170, x: 170, ease:Power2.easeOut}, 0)
.to("#icon-3", 1, {y: "+=160", x: "+160", ease:Power2.easeOut}, 0)
.to("#icon-4", 1, {y: "+=150", x: "+150", ease:Power2.easeOut}, 0)

.to("#circle-2", 1.2, {y: -170, x: 170, ease:Power2.easeOut}, 0)
.to("#icon-2", 1, {y: "-=160", x: "+160", ease:Power2.easeOut}, 0)

.to("#circle-4", 1.2, {y: 170, x: 170, ease:Power2.easeOut}, 0)
.to("#circle-3", 1.2, {y: 180, x: 0,   ease:Power2.easeOut}, 0)
.to("#icon-1, #line-icon-1", 1, {y: "+=70", x: "-=30", ease:Power2.easeOut}, 0)
...
.to("#icon-1", 1, {y: "-=160", x: "+=50", ease:Power2.easeOut}, 0)
.to("#icon-6", 1, {y: "+=150", x: "-=200", ease:Power2.easeOut}, 0.3)
.to("#icon-5", 1, {y: "-=10", x: "+=50", ease:Power2.easeOut}, 0.3)
...
.to("#circle-4", 1.2, {y: "-=90", x: "+=30", scale: 1.3, ease:Power2.easeOut}, 0)
