...
tl_.timeScale( 1 );  
tl_
.to("#circle-1-b", 2, {scale: 1.75, x: 150, y: 80,  ease:Power2.easeOut}, 0)
.to("#laptop", 2, {scale: 1.6, y: "-=25", x: "+=350",  ease:Power2.easeOut}, 0)
.to("#cloud", 2, {scale: 1.7, y: "-=25", x: "+=330",  ease:Power2.easeOut}, 0)
.to("#woman-1-a-circle", 2, {scale: 1, x: "-=150", y: "+=30", rotation: 0,  ease:Power2.easeOut}, 0)
...
.to("#circle-1-a", 2, {scale: 2, x: -100 + 930, y: 0,  ease:Power2.easeOut}, 0)
.to("#man-1-a-circle", 2, {scale: 1.1, y: -25, x: 930, ease:Power2.easeOut}, 0)
.to("[id='swoosh-1'], #Layer-smoosh-1", 2, {scale: 1.3, x: 20 + 930, y: 25, rotation: -10, ease:Power2.easeOut}, 0)

.staggerFrom("[id*='txt-1']", 1, {y: -10, autoAlpha: 0, rotation: 0.5, ease:Power2.easeOut}, 0.2, 1)
...
.to("#circle-1-b", 2, {x: -900, y: 200,  ease:Power2.easeOut}, 0)
.to("#laptop", 2, {x: -900  , y: 200,  ease:Power2.easeOut}, 0)
.to("#cloud", 2, {x: -900 , y: 200,  ease:Power2.easeOut}, 0)
.to("#woman-1-a-circle", 2, {x: -900, y: 200, rotation: 10,  ease:Power2.easeOut}, 0)
.to("#star, #start-woman", 2, {x: -900  , y: 200, rotation: 10,  ease:Power2.easeOut}, 0)

.to("#circle-1-a", 2, {x: -255,  ease:Power2.easeOut}, 0)
.from("#cat", 1, {x: 25, autoAlpha: 0, ease:Power2.easeOut}, 0.3)
.to("#man-1-a-circle", 2, {x: 82, y: 20,  ease:Power2.easeOut}, 0)
...
.to("#circle-1-a", 2, {x: -60, y: -210, scale: 2.1, ease:Power2.easeOut}, 0)
.to("#circle-1-b", 2, {x: -180, y: 300, scale: 1.6, ease:Power2.easeOut}, 0)
