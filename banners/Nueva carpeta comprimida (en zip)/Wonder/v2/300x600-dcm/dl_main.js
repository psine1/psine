...
.fromTo("#SVGID_man-1-a-circle", 1, {scale: 0, transformOrigin: "50% 50%",  ease:Power2.easeOut}, {scale: 1.4}, 0)
...
.from("#circle-1-b", 1, {scale: 0, transformOrigin: "80px 120px", ease:Power2.easeOut}, 0.15)
...
tl_.timeScale( 1 );  
tl_
.to("#circle-1-b", 2, {scale: 1.95, y: 80, x: -20,  ease:Power2.easeOut}, 0)
.to("#laptop", 2, {scale: 1, y: 300, x: 15,  ease:Power2.easeOut}, 0)
.to("#keyboard", 2, {scale: 1.05, y: -15, x: 60,  ease:Power2.easeOut}, 0)
.to("#woman-1-a-circle", 2, {scale: 1.1, x: 30, y: "-=10", ease:Power2.easeOut}, 0)
...
.to("#circle-1-b", 2, {x: "-=530", y: 250,  ease:Power2.easeOut}, 0)
.to("#laptop", 2, {x: -300, y: 200,  ease:Power2.easeOut}, 0)
.to("#keyboard", 2, {x: -300, y: 200,  ease:Power2.easeOut}, 0)
.to("#woman-1-a-circle, [id='swoosh-2']", 2, {x: -500, y: 200, rotation: 10,  ease:Power2.easeOut}, 0)
.to("#star, #start-woman", 2, {x: -300, y: 200, rotation: 10,  ease:Power2.easeOut}, 0)

.to("#circle-1-a", 2, {x: -120, y: -110, ease:Power2.easeOut}, 0)
.to("#monitor", 2, {x: -60, y: -310, scale: 1.1, rotation: 45, ease:Power2.easeOut}, 0)
...
.to("#circle-1-a", 2, {x: -70, y: -180, scale: 1.45, ease:Power2.easeOut}, 0)
.to("#circle-1-b", 2, {x: -70, y: 350, scale: 1.2, ease:Power2.easeOut}, 0.2)
