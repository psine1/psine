...
.fromTo("#SVGID_man-1-a-circle", 1, {scale: 0, transformOrigin: "50% 50%",  ease:Power2.easeOut}, {scale: 1.85}, 0)
...
.fromTo("#SVGID_woman-1-a-circle", 1, {scale: 0, transformOrigin: "50% 50%",  ease:Power2.easeOut}, {scale: 1.4}, 0.15)
...
tl_.timeScale( 1 );  
tl_
.to("#circle-1-b", 2, {scale: 2.3, x: 130, y: 80,  ease:Power2.easeOut}, 0)
.to("#laptop", 2, {scale: 1, y: 110, x: 300,  ease:Power2.easeOut}, 0)
.to("#keyboard", 2, {scale: 1.05, y: "+=30", x: -80,  ease:Power2.easeOut}, 0)
.to("#woman-1-a-circle", 2, {scale: 1.1, x: -80, y: "+=30", ease:Power2.easeOut}, 0)
.to("[id='swoosh-2'], #Layer-smoosh-2", 2, {scale: 1.2, x: -30 , y: 40, rotation: 10, ease:Power2.easeOut}, 0)
...
.to("#circle-1-a", 2, {scale: 1.65, x:  700, y: 0,  ease:Power2.easeOut}, 0)
.to("#monitor", 2, {scale: 1.6, y: 50, x: 0 + 600,  ease:Power2.easeOut}, 0)
.to("#man-1-a-circle", 2, {scale: 1.5, y: -25, x: 600, ease:Power2.easeOut}, 0)

.to("[id='swoosh-1'], #Layer-smoosh-1", 2, {scale: 1.8, x: 20 + 600, y: 25, rotation: -10, ease:Power2.easeOut}, 0)
...
.to("#circle-1-b", 2, {x: "-=630", y: "+=380",  ease:Power2.easeOut}, 0)
.to("#laptop", 2, {x: "-=630", y: "+=380",  ease:Power2.easeOut}, 0)
.to("#keyboard", 2, {x: "-=630", y: "+=380",  ease:Power2.easeOut}, 0)
.to("#woman-1-a-circle, [id='swoosh-2']", 2, {x: -300, y: "+=380", rotation: 10,  ease:Power2.easeOut}, 0)
.to("#star, #start-woman", 2, {x: "-=630", y: "+=380", rotation: 10,  ease:Power2.easeOut}, 0)

.to("#circle-1-a", 2, {x: -120,  ease:Power2.easeOut}, 0)
.to("#monitor", 2, {x: -300, y: 140, scale: 1.4, rotation: 35, ease:Power2.easeOut}, 0)
.to("#man-1-a-circle", 2, {x: 190, y: 30, scale: 1.15,  ease:Power2.easeOut}, 0)
...
.to("#circle-1-a", 2, {x: -30, y: -370, scale: 2.1, ease:Power2.easeOut}, 0)
.to("#circle-1-b", 2, {x: -180, y: 130, scale: 1.6, ease:Power2.easeOut}, 0)
