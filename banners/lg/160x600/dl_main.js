...
function fr2(){
    ...
    .from("[id*='img-1']", {duration: 1, scale: 7.3, transformOrigin: "50% 50%", y: 138, x: -18, ease: "power3.sout"}, 0)
...
function fr3(){
    ...
    .fromTo("[id*='svgId-2']", {x: 900}, {duration: 2, x: -100, ease: "power2.inOut"}, 0)
    .fromTo("[id*='svg-screen2']", {x: -1070}, {duration: 2, x: 0, ease: "power2.inOut"}, 0.5)


    .to("[id*='wrap-screen']", {duration: 5, scale: 0.65, x: 40, y: -125, ease: "power3.inOut"}, 4.5)

    .fromTo("#maskTv", {x: 0, y: 380, scale: 3.8, transformOrigin: "50% 50%"}, {duration: 5, scale: 1, x: 0, y: 0, ease: "power3.inOut"}, 4.5)
