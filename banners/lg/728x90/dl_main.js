...
function fr2(){
    ...
    .from("[id*='img-1']", {duration: 1, scale: 2.3, transformOrigin: "50% 50%", y: -23, x: 0, ease: "power3.sout"}, 0)
...
function fr3(){
    ...
    .to("[id*='wrap-screen']", {duration: 5, scale: 1, x: 0, y: -110, ease: "power3.inOut"}, 4.5)

    .fromTo("#maskTv", {x: -1000, y: 0, scale: 8.3, transformOrigin: "0% 0%"}, {duration: 5, scale: 1, x: 0, y: 0, ease: "power3.inOut"}, 4.5)
