...
function enableHover() {
  ...
  */
  ...
  .to("[id*='txt-1']", { duration: 0.3, scale: 1.5, x: -15, y: -50, color: "#fd5858", ease: "power2.inOut" }, "<")
  ...
  .to("[id*='txt-2']", { duration: 0.3, scale: 1.5, x: 50, y: -50, color: "#fd5858", ease: "power2.inOut" }, "<")
  ...
  .to("[id*='txt-3']", { duration: 0.3, scale: 1.5, x: 50, y: -15, color: "#fd5858", ease: "power2.inOut" }, "<")
  ...
  .to("[id*='txt-4']", { duration: 0.3, scale: 1.5, x: -50, y: 15, color: "#fd5858", ease: "power2.inOut" }, "<")
  ...
  .to("[id*='txt-5']", { duration: 0.3, scale: 1.8, x: 15, y: 35, color: "#fd5858", ease: "power2.inOut" }, "<")
  ...
  .to("[id*='txt-6']", { duration: 0.3, scale: 2, x: 50, y: 30, color: "#fd5858", ease:"power2.inOut" }, "<")  
