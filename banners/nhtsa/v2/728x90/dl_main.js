...
gsap.set(".wrapAnim", { scale: 0.28, y: -57, x: 489   })
gsap.set(".wrapMountain", { scale: 0.8 })
...
//      .to("[id*='car1'] img", { duration: 1.5, x: 3, repeat: -1, yoyo: true, ease: "none"  }, "<")
      ...
      .fromTo("[class*='wrapAd']", {scale: 2.2, transformOrigin: "82% 45%"}, { duration: 1, scale: 1, transformOrigin: "82% 45%", ease: "power2.out"  }, "<+0.2")
      .from("#wrapCar1", { duration: 2, autoAlpha: 0, ease: "slow(0.9,0.7,false)"  }, "<")

      

      
      .fromTo("#wrapCar1", {scale: 0.6}, { duration: 7.5, scale: 1.2, ease: "power3.out"  }, "<")
      .from("#wrapCar1", { duration: 7.5, x: -180, y: 15, ease: "power3.out"  }, "<")
