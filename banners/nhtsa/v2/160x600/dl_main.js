...
gsap.set(".wrapAnim", {scale: 0.78, y: 120, x: -60})
...
//      .to("[id*='car1'] img", { duration: 1.5, x: 3, repeat: -1, yoyo: true, ease: "none"  }, "<")
     ...
     // .to("[class*='wrapAd']", { duration: 1.5, scale: 1.4, transformOrigin: "81% 50%", ease: "power2.out"  }, "<")
      ...
      .from("#txt-2-4", { duration: 0.5, y: 20, autoAlpha: 0, ease: "power3.out"  }, "<+0.2")   
      .from("#txt-2-5", { duration: 0.5, y: 20, autoAlpha: 0, ease: "power3.out"  }, "<+0.2")   
