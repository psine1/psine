...
//gsap.set("#wrapWay", {rotation: 360})
      ...
      gsap.set(".wrapAnim", {scale: 0.92, y: 20, x: -70})
      gsap.set("#bg", {scale: 1.15, transformOrigin: "50% 100%"})
  ...
  const tl_All = gsap.timeline({  });
      ...
      .to("[id*='car1']", { duration: 3, x: -20, y: -5, ease: "power2.inOut"  }, "<")
      ...
      .to(".wrapAda", { duration: 3, scale: 1.3, transformOrigin: "30% 80%", ease: "power3.out"  }, "<+1.2")
      
        
      .to("#fr2inner", { duration: 1, scale: 1.05, ease: "power2.out"  }, "<+1")
      ...
      .to("#wrapElipse", { duration: 0.5, scale: 1.3, x: 30,  y: 30, ease: "power2.inOut"  }, "<")
      ...
      .to(".wrapAnim", { duration: 0.01, scale: 0.7, x: -25, y: 52, ease: "power2.inOut"  }, "<")
      .to("#bg", 0.01, {scale: 1, transformOrigin: "50% 100%"}, "<")
      ...
      .from("#txt-3-6", { duration: 0.5, y: 20, autoAlpha: 0, ease: "power3.out"  }, "<+0.2")    
