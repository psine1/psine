...
//gsap.set(".wrapAnim", {scale: 0.44})
gsap.set(".wrapAnim", {scale: 0.44})

//gsap.set(".wrapAd", {scale: 1.05, y: -20, x: -75, transformOrigin: "100% 80%"})
gsap.set(".wrapAd", {scale: 1.13, y: 0, x: 0, transformOrigin: "100% 80%"})

  const tl_All = gsap.timeline({  });

      tl_All.timeScale(1);  
      tl_All
      .to("[id*='barandas'] img", { duration: 0.5, x: -1, scale: 0.95, transformOrigin: "60% 50%", y: -3, repeat: -1, yoyo: false, ease: "none"  }, "<")
      ...
      .to(".wrapAd", { duration: 3, scale: 1.4, transformOrigin: "100% 80%", ease: "power3.out"  }, "<+1.2")
          
      .to("#wrapElipse", { duration: 3, x: -50, ease: "power3.out"  }, "<")

        
      .to("#fr2inner", { duration: 1, scale: 1.05, x: 0, y: 0, ease: "power2.out"  }, "<+1")
      .from("#fr2inner", { duration: 0.25, autoAlpha: 0, ease: "power2.out"  }, "<")

      .to("#wrapElipse svg", { duration: 0.01, x: -50, y: 5, ease: "power3.out"  }, "<")
      ...
      .to("#wrapElipse", { duration: 0.01, scale: 1.08, ease: "power2.inOut"  }, "<")
      ...
      .to("[id*='car1']", { duration: 2, x: 0, y: 0, ease: "power2.out"  }, "<+1.5")
            ...
            .to(".wrapAd", { duration: 2, scale: 1, transformOrigin: "100% 80%", ease: "power3.out"  }, "<")
      .to("[id*='wrapElipse']", { duration: 0.5, autoAlpha: 0, ease: "power3.out"  }, "<")

      .to("#fr2", { duration: 0.25, autoAlpha: 0 , ease: "power2.out"  }, "<")

      .from("#overlay", { duration: 0.25, x: -60 , ease: "power2.out"  }, "<")
