...
function pauseAllAnimations() {
  ...
  const tl_All = gsap.timeline({  });
      ...
      .to("#bg", { duration: 10, scale: 2, transformOrigin: "66px 382px", ease: "power3.out"  }, "<")
      
      .to("#wheel1 img, #wheel2 img", { duration: 0.3, rotation: -360, repeat: -1, ease: "none"  }, "<")



      .to("[id*='car1']", { duration: 3, x: 35, y: -5, ease: "power2.inOut"  }, "<")
      ...
      .fromTo("#bg", {scale: 1}, { duration: 10, scale: 2, transformOrigin: "66px 382px", ease: "power3.out"  }, "<")
