...
function pauseAllAnimations() {
  timelines.forEach(tl => tl.pause());
    ...
    gsap.set(".wrapAnim", { scale: 0.5, x: -65, ease: "power3.out"  })

    gsap.set(".wrapAd", { scale: 1.5, x: -270, y: 20, ease: "power3.out"  })

    gsap.set("#bg, #wrapWay", { scale: 1, transformOrigin: "50% 100%" })
    gsap.set("#wrapWay", { rotation: 14, x: 0 })

          gsap.set("#wrapCar2", { scale: 0.8, y: 10  })
  ...
  const tl_All = gsap.timeline({  });
      ...
      .to("#bg, #wrapWay", { duration: 0.01, scale: 1, transformOrigin: "50% 100%", ease: "power3.out"  }, "<")
      ...
      .to("#bg, #wrapWay", { duration: 7, scale: 1, transformOrigin: "50% 100%", ease: "power3.out"  }, "<")
      
      .to("#wheel1 img, #wheel2 img", { duration: 0.3, rotation: -360, repeat: -1, ease: "none"  }, "<")



      .to("[id*='car1']", { duration: 3, x: 17, y: -5, ease: "power2.inOut"  }, "<")
      .from("[id*='car1-lightR']", { duration: 0.35, autoAlpha: 0, repeat: 7, yoyo: true, ease: "none"  }, "<")

      .to("#wrapCar2", { duration: 4, x: -25, y: 0, ease: "power2.inOut"  }, "<-0.2")

//      .to(".wrapAd", { duration: 5, scale: 1, ease: "power3.out"  }, "<+1.2")

      .from("#wrapElipse", { duration: 0.5, scale: 0, ease: "power2.inOut"  }, "<+1.2")
      ...
      .to("#bg2", { duration: 1, scale: 1.05, ease: "power2.out"  }, "<+1.2")
      ...
      .to(".wrapAd", { duration: 0.01, scale: 1, x: 0, y: 0, ease: "power3.out"  }, "<")
      .to("#wrapCar2", 0.01,{ scale: 1, y: 0  }, "<")
      .to("#wrapElipse", { duration: 0.01, scale: 0, ease: "power2.inOut"  }, "<")

      .to(".wrapAnim", 0.01, { scale: 0.5, x: -37, y: 10, ease: "power3.out"  }, "<+0.01")
      ...
      .to("#bg, #wrapWay", { duration: 0.01, scale: 1, transformOrigin: "50% 100%", ease: "power3.out",  overwrite: "auto" }, "<")
      ...
      .fromTo("#bg, #wrapWay", {scale: 1}, { duration: 4, scale: 1, transformOrigin: "50% 100%", ease: "power3.out"  }, "<")
   ...
   //   .to("[id*='wrapElipse']", { duration: 0.01, autoAlpha: 0, ease: "power3.out"  }, "<")
      ...
      .add(function () {  pauseAllAnimations()  }, "<+2")
