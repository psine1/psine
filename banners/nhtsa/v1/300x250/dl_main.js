...
function pauseAllAnimations() {
  timelines.forEach(tl => tl.pause());
    ...
    gsap.set("#bg", { scale: 0.54, transformOrigin: "179px 230px" })
  ...
  const tl_All = gsap.timeline({  });
      ...
      tl_All
            ...
            .to("#bg", { duration: 0.01, scale: 0.54, transformOrigin: "179px 230px", ease: "power3.out"  }, "<")
      ...
      .to("#bg", { duration: 7, scale: 1.35, transformOrigin: "179px 230px", ease: "power3.out"  }, "<")
      
      .to("#wheel1 img, #wheel2 img", { duration: 0.3, rotation: -360, repeat: -1, ease: "none"  }, "<")



      .to("[id*='car1']", { duration: 3, x: 23, y: -5, ease: "power2.inOut"  }, "<")
   ...
   //   .to(".wrapAd", { duration: 5, scale: 1.5, transformOrigin: "200px 382px", ease: "power3.out"  }, "<+1.2")
      ...
      .from("#wrapElipse", { duration: 0.5, scale: 0, ease: "power2.inOut"  }, "<+0.75")
      ...
      .to("#bg2", { duration: 1, scale: 1.05, x: 5, y: 5, ease: "power2.out"  }, "<+0.75")
      ...
      .to("#bg", { duration: 0.01, scale: 0.54, transformOrigin: "179px 230px", ease: "power3.out",  overwrite: "auto" }, "<")

      .to(".wrapAd", { duration: 0.01, scale: 1, y: 0, transformOrigin: "123px 186px", ease: "power3.out"  }, "<+0.2")
      ...
      .fromTo("#bg", {scale: 0.75}, { duration: 4, scale: 1.35, transformOrigin: "179px 230px", ease: "power3.out"  }, "<")
