...
function fr1(){
  var tl_ = gsap.timeline();
    ...
    .to("#svgMask", {duration: 0.5, scale: 24}, ">-0.2")
    .to("#overlay", {duration: 0.01, autoAlpha: 0}, "<")


	  .from('#bg', 18, {scale: 1.56, rotation: 0.05, transformOrigin: "60% 50%", ease: "power3.out"}, "<")
    ...
    .from('[id*="txt-3-"]', 1, {autoAlpha: 0, y: 20, stagger: 0.15, ease: "power3.out"}, "<+0.5")
...
function initHandlers() {
  ...
  var a = {
    enter: function () {
      ...
      tl
      .to("#btn-text", 0.2, {x: 3, ease:Power2.easeOut}, 0)
      .to("#btn-arrow", 0.2, {x: 7, ease:Power2.easeOut}, 0)
    ...
    leave: function () {
      ...
      tl
      .to("#btn-text", 0.2, {x: 0, background: "transparent", ease:Power2.easeOut}, 0)
      .to("#btn-arrow", 0.2, {x: 0, background: "transparent", ease:Power2.easeOut}, 0)
