...
function fr1(){ 
        ...
        tl_.timeScale( 1 );  
        tl_
        .to('#road', 8, {x: -59, y: -33, scale: 1.35, ease:Power3.easeOut}, 0)
        .fromTo('#maskroad', 8, {x: -5, y: -3}, {x: -59, y: -30, scale: 1.35, ease:Power3.easeOut}, 0)
...
function fr2(){ 
    ...
    tl_
          ...
          .from('#bg-fr2', 8, {scale: 1.35, y: -10, ease:Power3.easeOut}, 0)
          .from('#mountain-fr2', 8, {scale: 1.35, x: 40, y: -10, ease:Power3.easeOut}, 0)
...
function fr3(){ 
    ...
    tl_
          ...
          .from('#bg-fr3', 8, {scale: 1.2, x: -30, ease:Power3.easeOut}, 0)
          .from('#people', 8, {scale: 1.25, x: -30, y: -10, ease:Power3.easeOut}, 0)
...
tl_.timeScale( 1 );  
tl_
      .fromTo('#color-1', 2.2, {x: 0, y: 0}, {x: -1700, y: -1700, ease:Power3.easeInOut}, 0)
      .fromTo('#color-2', 1.95, {x: 0, y: 0}, {x: -1700, y: -1700, ease:Power3.easeInOut}, 0.2)
      .fromTo('#color-3', 1.85, {x: 0, y: 0}, {x: -1700, y: -1700, ease:Power3.easeInOut}, 0.25)
      .fromTo('#color-4', 1.65, {x: 0, y: 0}, {x: -1700, y: -1700, ease:Power3.easeInOut}, 0.35)      
      ;
return tl_  
}
