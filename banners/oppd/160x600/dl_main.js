...
.to("[id*='city-1'], [id*='city-6']", 18, {ease:Power1.easeInOut, x: -1070}, 0)
.to("[id*='city-2']", 18, {ease:Power1.easeInOut, x: -938}, 0)

.to("[id*='gradient']", 18, {ease:Power1.easeInOut, x: -938}, 0)
.fromTo("[id*='city-3']", 18, {x: -40}, {ease:Power1.easeInOut, x: -938}, 0)
.fromTo("[id*='city-4'], [id*='city-8']", 16.5, {x: -50}, {ease:Power1.easeInOut, x: -800}, 0)


//.fromTo("[id*='city-5']", 18, {x: -180}, {ease:Power1.easeInOut, rotation: -3, y: -8, x: -850}, 0)

.fromTo("[id*='city-5']", 18, {x: -400}, {ease:Power1.easeInOut, x: -750}, 0)
.to("[id*='city-5'] img", 9, {ease:Power1.easeInOut, rotation: -14, y: -18}, 8)

.to("[id*='city-6'], [id*='city-7']", 18, {ease:Power1.easeInOut, x: -1070}, 0)
...
tl_storm
.to("#trunk-1-small", 2, {morphSVG:"#trunk-2-small", ease:Power1.easeInOut}, 5.7)
.to("#tree-small", 2, {rotation: 45, ease:Power1.easeInOut}, 5.7)
.to("#trunk-1-big", 2, {morphSVG:"#trunk-2-big", ease:Power1.easeInOut}, 5.8)
.to("#tree-big", 2, {rotation: 45, x: 10, ease:Power1.easeInOut}, 5.8)

.from("[id*='city-8-ray'] img", 0.7, { scale: 0, opacity: 0.5, y: -20}, 7.5)
.to("[id*='city-8-ray'] img", 0.7, { scale: 1.3, y: -5, opacity: 0}, "-=0.2")

.to("[id*='gradient'] img", 0.35, {  opacity: 0.75, repeat: 3, yoyo: true }, 7.4)
