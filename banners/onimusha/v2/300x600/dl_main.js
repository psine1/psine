...
function fr1() {
  ...
  gsap.set("[id*='txt-1-']", { autoAlpha: 0, y: 0, scale: 2, transformOrigin: "50% 20%" }, 0)
  gsap.set("[id*='txt-2-']", { autoAlpha: 0, y: 0, scale: 2, transformOrigin: "50% 50%" }, 0)
  gsap.set("[id*='txt-3-']", { autoAlpha: 0, y: 0, scale: 2, transformOrigin: "50% 70%" }, 0)
